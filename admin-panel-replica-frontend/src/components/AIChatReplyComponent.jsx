const AIChatReplyComponent = ({sender, children}) => {
    return <div className="relative  px-2 mx-4 ml-12 my-2">
        ...
        <div className={` rounded-xl w-fit ${sender == 'ai' ? 'p-4 bg-gradient-to-br from-[#cbcef4] via-[#ded0eb] to-[#f0d5d7]' : 'px-0 py-2'}`}>
            ...
            {sender == 'ai' && <div className="flex items-center cursor-pointer mt-4 bg-white  rounded-lg">
                <div className="flex justify-center items-center gap-2 border-r-2 border-gray-300 w-[85%] xl:w-[90%] my-2">
                ...
                <div className="">
                    <svg className="w-2.5 h-2.5 ml-3" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="512" height="298" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 298.04"><path fillRule="nonzero" d="M12.08 70.78c-16.17-16.24-16.09-42.54.15-58.7 16.25-16.17 42.54-16.09 58.71.15L256 197.76 441.06 12.23c16.17-16.24 42.46-16.32 58.71-.15 16.24 16.16 16.32 42.46.15 58.7L285.27 285.96c-16.24 16.17-42.54 16.09-58.7-.15L12.08 70.78z"/></svg>
                </div>
            </div>}
        </div>
        <div className={`absolute top-0 ${sender == 'ai' ? '-left-7.5' : '-left-8'}`}>{sender == 'ai' ? <img className="w-6 h-6 " src="./Intercom_idJtqMxXFx_0.svg" /> : <div className="rounded-full w-7 h-7 flex justify-center items-center text-white bg-red-800">S</div>}</div>
    </div>
}
