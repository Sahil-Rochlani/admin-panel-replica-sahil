...
const CustomerChatPanel = () => {
  ...
  return (
    <div className="relative bg-white dark:bg-white overflow-y-hidden col-span-5 lg:col-span-4 h-dvh py-2 scroll-smooth border-r-1 border-gray-300">
      <div className="dark:bg-white bg-white w-full flex items-center py-1 justify-between px-6 border-b-1 border-gray-300">
