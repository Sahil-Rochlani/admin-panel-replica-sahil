        ...
        <div className="border-b-2 flex justify-between border-gray-200 px-8  py-4  text-sm">
            ...
            <div className="flex flex-col justify-between">
                <div className="flex items-center gap-2">
                    <div className={`flex text-white  justify-center items-center text-xs w-5 h-5 rounded-full ${adminDetails.bgColor ? adminDetails.bgColor : ''}`}>{adminDetails.imageUrl ? <img className="rounded-full" src="https://img.freepik.com/premium-photo/adult-man-serene-face-expression-studio-portrait_53876-75419.jpg?uid=R197307981&ga=GA1.1.1783492781.1737620913&semt=ais_hybrid&w=740"/> : adminDetails.name.at(0).toUpperCase()}</div>
